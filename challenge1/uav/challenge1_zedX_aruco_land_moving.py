...
# LOOSER MARGINS: Because the UGV is driving, the camera latency creates a natural offset. 
# It will realistically never achieve 0.05m tolerance while moving.
CENTER_TOLERANCE_M = 0.28       # Allowed XY error radius to begin descent
FINAL_CENTER_TOLERANCE_M = 0.18 # Allowed XY error to execute final LAND
START_DESCENT_IF_DOWN_M = 1.6   
FINAL_SWITCH_TO_LAND_DOWN_M = 0.35

# Velocities
# MUCH FASTER: Must be high enough to match the UGV driving speed!
MAX_XY_SPEED_MPS = 1.80
DESCENT_SPEED_MPS = 0.25  

# Proportional control gains
# AGGRESSIVE: Needs to bank hard to stop itself from drifting behind
KP_FORWARD = 1.2
KP_RIGHT = 1.2
